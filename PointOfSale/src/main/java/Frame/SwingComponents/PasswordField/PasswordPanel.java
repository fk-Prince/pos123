package Frame.SwingComponents.PasswordField;
...
public class PasswordPanel extends JPanel {
    ...
    public PasswordPanel(String text, String image) {
        ...
        button.addActionListener(e -> {
            ...
            if (isPasswordToggled) {
                ...
                input.setEchoChar('\u0000');
                Image x1 = new ImageIcon(getClass().getResource("/Image/pshow.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
                button.setIcon(new ImageIcon(x1));
            } else {
                input.setEchoChar('•');
                Image x1 = new ImageIcon(getClass().getResource("/Image/phide.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
                button.setIcon(new ImageIcon(x1));
            }
        });
        button.setBorder(new EmptyBorder(0, 10, 0, 10));
        Image x = new ImageIcon(getClass().getResource("/Image/phide.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
    ...
    public void isInputValid(boolean isInputValid) {
